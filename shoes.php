...
<div class="modal  m-lg-5" id="myModal">
    <div class="modal-dialog">
        <div style="" class=" loginBox modal-content">
            ...
            <h3>Sign in here</h3>
            <form style="width: 100%" action="shoes.php" method="post">
...
<div class="container" >
    <div class="row" style="margin-top: 100px;display: flex; font-size: 20px ">
        <ul class="header-title" >
            ...
            <li >
                <span> &nbsp> Shoes</span>
            </li>
        </ul>
    </div>
    <hr>
    <div class="row spann title" >
        <span>Shoes</span>
    </div>

    <div class="department row" >
        <a href="men.php?type=Shoes" id="jeans" >
            <img src="imgs/col4.jpg" alt="">
            <label for="a1" style="">Men</label>
        </a>
        <a href="woman.php?type=Shoes" >
            <img src="imgs/col1.jpg" alt="">
            <label for="a1" style="">Woman</label>
        </a>
        <a href="children.php?type=Shoes" >
            <img src="imgs/children1.jpg" alt="">
